...
namespace SQS.nTier.TTM.DTO
{
    ...
    public partial class TSOServiceDeliveryChainDTO : IBaseDTO
    {
        public TSOServiceDeliveryChainDTO()
        {
            ...
            TSOServiceDeliveryChainActualRisks = new HashSet<TSOServiceDeliveryChainActualRiskDTO>();

            //TSOServiceDeliveryChainPlannedRisks = new HashSet<TSOServiceDeliveryChainPlannedRiskDTO>();
        }
        [JsonProperty("ID")]
        ...
        [JsonProperty("TSOServiceDeliveryChainActualRisks")]
        public virtual ICollection<TSOServiceDeliveryChainActualRiskDTO> TSOServiceDeliveryChainActualRisks { get; set; }
        //[JsonProperty("TSOServiceDeliveryChainPlannedRisks")]
        //public virtual ICollection<TSOServiceDeliveryChainPlannedRiskDTO> TSOServiceDeliveryChainPlannedRisks { get; set; }

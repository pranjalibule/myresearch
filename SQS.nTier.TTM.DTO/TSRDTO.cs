...
namespace SQS.nTier.TTM.DTO
{
    ...
    public class TSRDTO : IBaseDTO
    {
        ...
        public string TSRTMOArr { get; set; }
        ...
        public virtual ProjectModelDTO ProjectModel { get; set; }
        ...
        [JsonProperty("TSRTMOUsers")]
        public virtual ICollection<TSRTMOUserDTO> TSRTMOUsers { get; set; }
        ...
        [JsonProperty("ChildTSOPlannedEffortSum")]
        public virtual double ChildTSOPlannedEffortSum { get; set; }
    }
}
